...
<div class="card mt-4">
    <div class="card-body">
        ...
        <form method="post" action="{{route('supplier.update', $data->id_supp) }}">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_supp" name="nama_supp" value="{{ $data->nama_supp }}">
            </div>

            <div class="mb-3">
                <label for="kota_supp" class="form-label">Domisili</label>
                <input type="text" class="form-control" id="kota_supp" name="kota_supp" value="{{ $data->kota_supp }}">
            </div>

            <div class="mb-3">
                <label for="noTelp_supp" class="form-label">Kontak</label>
                <input type="text" class="form-control" id="noTelp_supp" name="noTelp_supp"
                    value="{{ $data->noTelp_supp }}">
            </div>
